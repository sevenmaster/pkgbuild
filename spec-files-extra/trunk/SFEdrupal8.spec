...
#enable openssl
#enable gd
#enable opcache (fehlt im Solaris11 PHP 5.6??)
...
%define     src_name_minor_extra 
#from pnm %define     apache2_majorversion
#from pnm %define     apache2_version 2.2
#IPS_component_version: <numeric-only>

Name:                SFEdrupal8
IPS_Package_Name:	 web/service/drupal-8
...
#manual dependency Requires:            %{pnm_requires_SUNWapch22}
#manual dependency Requires:            %{pnm_requires_SUNWapch22m_php52}
#manual dependency Requires:            %{pnm_requires_SUNWphp52_mysql}
#manual dependency Requires:            %{pnm_requires_SUNWphp52}
...
%description
Needs minimum PHP version 5.6 or later ( pkg set-mediator -V 5.6 php )
Drupal CMS System
see the SFE project web for initial setup instructions and see www.drupal.org for
...
- bump to version 8.5.0 Drupal Core - Critical - Multiple Vulnerabilities - SA-CORE-2018-001 fixed in version 8.4.5
* Mon Nov 27 2017 - Thomas Wager
- bump to version 8.4.2
* Fri Nov  3 2017 - Thomas Wager
- bump to version 8.4.1
* Sat Jul 29 2017 - Thomas Wager
- svn copy from SFEdrupal7.spec
- bump to version 8.3.5
