...
%description devel
Includes and definitions for developing with librevenge.
...
export PKG_CONFIG_PATH=%{gpp_lib}/pkgconfig
...
%{_libdir}/%{src_name}-generators-%{major_version}.%{minor_version}.so*
%{_libdir}/%{src_name}-stream-%{major_version}.%{minor_version}.so*

%dir %attr (0755, root, other) %{_libdir}/pkgconfig
%{_libdir}/pkgconfig/%{src_name}-%{major_version}.%{minor_version}.pc
%{_libdir}/pkgconfig/%{src_name}-generators-%{major_version}.%{minor_version}.pc
%{_libdir}/pkgconfig/%{src_name}-stream-%{major_version}.%{minor_version}.pc
...
%_includedir/%{src_name}-%{major_version}.%{minor_version}/%{src_name}-generators
%_includedir/%{src_name}-%{major_version}.%{minor_version}/%{src_name}-stream


%changelog
* Tue May 31 2016 - pjama
- bump from 0.0.3 to 0.0.4
- change version vars to major, minor, micro
- tidy up %vars to %{vars} for readability
