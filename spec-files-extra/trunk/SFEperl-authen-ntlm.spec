#
# spec file for package: SFEperl-authen-ntlm
#
...
Summary:	Authen::NTLM - Authen::NTLM
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~nbebout/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/N/NB/NBEBOUT/NTLM-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Nick Bebout <nbebout@cpan.org>
Meta(info.upstream_url):        http://search.cpan.org/~nbebout/%{tarball_name}-%{tarball_version}
