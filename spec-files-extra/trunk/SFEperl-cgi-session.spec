#
# spec file for package: SFEperl-cgi-session
#
...
%define tarball_version 4.48
%define tarball_name    CGI-Session

Name:		SFEperl-cgi-session
IPS_package_name: library/perl-5/cgi-session
Version:	4.48
IPS_component_version: 4.48
Group:          Development/Libraries                    
Summary:	CGI::Session - Session management in CGI  applications
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~sherzodr/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/M/MA/MARKSTOS/CGI-Session-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Sherzod Ruzmetov <sherzodr@cpan.org>
Meta(info.upstream_url):        http://search.cpan.org/~sherzodr/%{tarball_name}-%{tarball_version}
