#
# spec file for package: SFEperl-cgi
#
...
Url:		http://search.cpan.org/~lds/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/L/LE/LEEJO/CGI-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Lincoln D. Stein <lincoln.stein@gmail.com>
Meta(info.upstream_url):        http://search.cpan.org/~lds/%{tarball_name}-%{tarball_version}
