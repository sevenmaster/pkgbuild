#
# spec file for package: SFEperl-cpan
#
...
%define tarball_name    CPAN

Name:		SFEperl-cpan
IPS_package_name: library/perl-5/cpan
Version:	2.10
IPS_component_version: 2.10
Group:          Development/Libraries                    
Summary:	CPAN - Perl Archive browse and download
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~andk/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/A/AN/ANDK/CPAN-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Andreas J. Koenig <andreas.koenig.7os6vvqr@franz.ak.mind.de>
Meta(info.upstream_url):        http://search.cpan.org/~andk/%{tarball_name}-%{tarball_version}
