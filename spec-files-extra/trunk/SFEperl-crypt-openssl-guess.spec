#
# spec file for package: SFEperl-crypt-openssl-guess
#
...
%define tarball_name    Crypt-OpenSSL-Guess

Name:		SFEperl-crypt-openssl-guess
IPS_package_name: library/perl-5/crypt-openssl-guess
Version:	0.11
IPS_component_version: 0.11
Group:          Development/Libraries                    
Summary:	Crypt::OpenSSL::Guess - Crypt::OpenSSL::Guess
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~akiym/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/A/AK/AKIYM/Crypt-OpenSSL-Guess-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Takumi Akiyama <t.akiym@gmail.com>
Meta(info.upstream_url):        http://search.cpan.org/~akiym/%{tarball_name}-%{tarball_version}
