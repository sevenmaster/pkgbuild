#
# spec file for package: SFEperl-crypt-openssl-rsa
#
...
%define tarball_name    Crypt-OpenSSL-RSA

Name:		SFEperl-crypt-openssl-rsa
IPS_package_name: library/perl-5/crypt-openssl-rsa
Version:	0.31
IPS_component_version: 0.31
Group:          Development/Libraries                    
Summary:	Crypt::OpenSSL::RSA - Crypt::OpenSSL::RSA
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~perler/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/T/TO/TODDR/Crypt-OpenSSL-RSA-%{tarball_version}.tar.gz
...
Meta(info.upstream_url):        http://search.cpan.org/~perler/%{tarball_name}-%{tarball_version}
