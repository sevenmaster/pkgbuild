#
# spec file for package: SFEperl-curses-ui
#
...
%define tarball_version 0.9609
%define tarball_name    Curses-UI

Name:		SFEperl-curses-ui
IPS_package_name: library/perl-5/curses-ui
Version:	0.9609
IPS_component_version: 0.9609
Group:          Development/Libraries                    
Summary:	Curses::UI - Curses::UI
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~mdxi/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/M/MD/MDXI/Curses-UI-%{tarball_version}.tar.gz
