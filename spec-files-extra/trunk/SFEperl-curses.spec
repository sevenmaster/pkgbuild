#
# spec file for package: SFEperl-curses
#
...
%define tarball_name    Curses

Name:		SFEperl-curses
IPS_package_name: library/perl-5/curses
Version:	1.36
...
Url:		http://search.cpan.org/~giraffed/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/G/GI/GIRAFFED/Curses-%{tarball_version}.tar.gz
...
Meta(info.upstream_url):        http://search.cpan.org/~giraffed/%{tarball_name}-%{tarball_version}
