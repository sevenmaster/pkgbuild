#
# spec file for package: SFEperl-data-processor
#
...
%define tarball_version 0.4.3
%define tarball_name    Data-Processor

Name:		SFEperl-data-processor
IPS_package_name: library/perl-5/data-processor
Version:	0.4.3
IPS_component_version: 0.4.3
Group:          Development/Libraries                    
Summary:	Data::Processor - Data::Processor
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~mbp/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/M/MB/MBP/Data-Processor-0.4.3.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

#BuildRequires: ExtUtils::MakeMaker

BuildRequires: SFEperl-dist-milla
Requires:      SFEperl-dist-milla
BuildRequires: SFEperl-test-pod
Requires:      SFEperl-test-pod

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Matthias Bloch <mbp@cpan.org>
Meta(info.upstream_url):        http://search.cpan.org/~mbp/%{tarball_name}-%{tarball_version}
...
- initial spec (for SFEkvmadm.spec)
