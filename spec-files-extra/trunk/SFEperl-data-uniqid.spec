#
# spec file for package: SFEperl-data-uniqid
#
...
%define tarball_name    Data-Uniqid

Name:		SFEperl-data-uniqid
IPS_package_name: library/perl-5/data-uniqid
Version:	0.12
IPS_component_version: 0.12
Group:          Development/Libraries                    
Summary:	Data::Uniqid - Data::Uniqid
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~mwx/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/M/MW/MWX/Data-Uniqid-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Mike Wesemann <mwx@gmx.de>
Meta(info.upstream_url):        http://search.cpan.org/~mwx/%{tarball_name}-%{tarball_version}
