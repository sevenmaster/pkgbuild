##NOTICE## Version in tarball is *NON* *STANDARD* numbering scheme

#
# spec file for package: SFEperl-dist-milla
#
...
%define tarball_name    Dist-Milla

Name:		SFEperl-dist-milla
IPS_package_name: library/perl-5/dist-milla
##NOTICE##
Version:	1.0.18
IPS_component_version: 1.0.18
Group:          Development/Libraries                    
Summary:	Dist::Milla - Dist::Milla
License:	Artistic
...
Source0:	http://search.cpan.org/CPAN/authors/id/M/MI/MIYAGAWA/Dist-Milla-v1.0.18.tar.gz
...
%prep
##NOTICE## Version in tarball is *NON* *STANDARD* numbering scheme
%setup -q -n %{tarball_name}-v%{tarball_version}
...
#%{_bindir}/*
%dir %attr(0755,root,bin) %{_prefix}/perl%{perl_major_version}/%{perl_version}/bin
%{_prefix}/perl%{perl_major_version}/%{perl_version}/bin/*
