#
# spec file for package: SFEperl-extutils-config
#
...
%define tarball_name    ExtUtils-Config

Name:		SFEperl-extutils-config
IPS_package_name: library/perl-5/extutils-config
Version:	0.008
IPS_component_version: 0.8
Group:          Development/Libraries                    
Summary:	ExtUtils::Config - ExtUtils::Config
License:	Artistic
...
Source0:	http://search.cpan.org/CPAN/authors/id/L/LE/LEONT/ExtUtils-Config-%{tarball_version}.tar.gz
