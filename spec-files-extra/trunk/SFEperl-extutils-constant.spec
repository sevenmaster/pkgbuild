#
# spec file for package: SFEperl-extutils-constant
#
...
%define tarball_name    ExtUtils-Constant

Name:		SFEperl-extutils-constant
IPS_package_name: library/perl-5/extutils-constant
Version:	0.23
IPS_component_version: 0.23
Group:          Development/Libraries                    
Summary:	ExtUtils::Constant - ExtUtils::Constant
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~nwclark/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/N/NW/NWCLARK/ExtUtils-Constant-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Nicholas Clark <nwc10+please+use+perlbug+for+perl+queries@colon.colondot.net>
Meta(info.upstream_url):        http://search.cpan.org/~nwclark/%{tarball_name}-%{tarball_version}
