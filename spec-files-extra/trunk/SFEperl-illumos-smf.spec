#
# spec file for package: SFEperl-illumos-smf
#
...
%define tarball_name    Illumos-SMF

Name:		SFEperl-illumos-smf
IPS_package_name: library/perl-5/illumos-smf
Version:	0.1.6
IPS_component_version: 0.1.6
Group:          Development/Libraries                    
Summary:	Illumos::SMF - Illumos::SMF
License:	Artistic
...
Source0:	http://search.cpan.org/CPAN/authors/id/H/HA/HADFL/Illumos-SMF-0.1.6.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

BuildRequires:  SFEperl-illumos-zones
Requires:       SFEperl-illumos-zones
