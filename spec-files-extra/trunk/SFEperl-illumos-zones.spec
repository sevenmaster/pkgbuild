#
# spec file for package: SFEperl-illumos-zones
#
...
%define tarball_name    Illumos-Zones

Name:		SFEperl-illumos-zones
IPS_package_name: library/perl-5/illumos-zones
Version:	0.001004
IPS_component_version: 0.1.4
Group:          Development/Libraries                    
Summary:	Illumos::Zones - Illumos::Zones
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~hadfl/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/H/HA/HADFL/Illumos-Zones-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

BuildRequires:  SFEperl-data-processor
Requires:       SFEperl-data-processor

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Dominik Hassler <hadfl@cpan.org>
Meta(info.upstream_url):        http://search.cpan.org/~hadfl/%{tarball_name}-%{tarball_version}
