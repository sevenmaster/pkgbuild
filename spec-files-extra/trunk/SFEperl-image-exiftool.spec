...
%define tarball_version 10.10
%define tarball_name    Image-ExifTool

Name:		SFEperl-image-exiftool
IPS_package_name: library/perl-5/image-exiftool
Version:	10.10
IPS_component_version: 10.10
Group:          Development/Libraries                    
Summary:	Image::ExifTool - Read and write meta information in images
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~exiftool/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/E/EX/EXIFTOOL/Image-ExifTool-%{tarball_version}.tar.gz
...
Meta(info.upstream):            Phil Harvey <phil at owl.phy.queensu.ca>
Meta(info.upstream_url):        http://search.cpan.org/~exiftool/%{tarball_name}-%{tarball_version}
