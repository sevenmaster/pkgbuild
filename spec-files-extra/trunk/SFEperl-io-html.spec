#
# spec file for package: SFEperl-io-html
#
...
%define tarball_version 1.001
%define tarball_name    IO-HTML

Name:		SFEperl-io-html
IPS_package_name: library/perl-5/io-html
Version:	1.001
IPS_component_version: 1.1
Group:          Development/Libraries                    
Summary:	IO::HTML - IO::HTML
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~cjm/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/C/CJ/CJM/IO-HTML-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Christopher J. Madsen <perl@cjmweb.net>
Meta(info.upstream_url):        http://search.cpan.org/~cjm/%{tarball_name}-%{tarball_version}
