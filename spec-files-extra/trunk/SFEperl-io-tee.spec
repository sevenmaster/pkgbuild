#
# spec file for package: SFEperl-io-tee
#
...
%define tarball_version 0.65
%define tarball_name    IO-Tee

Name:		SFEperl-io-tee
IPS_package_name: library/perl-5/io-tee
Version:	0.65
IPS_component_version: 0.65
Group:          Development/Libraries                    
Summary:	IO::Tee - IO::Tee
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~kenshan/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/N/NE/NEILB/IO-Tee-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Chung-chieh Shan <ccshan@post.harvard.edu>
Meta(info.upstream_url):        http://search.cpan.org/~kenshan/%{tarball_name}-%{tarball_version}
