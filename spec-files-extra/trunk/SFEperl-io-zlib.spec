#
# spec file for package: SFEperl-io-zlib
#
...
%define tarball_name    IO-Zlib

Name:		SFEperl-io-zlib
IPS_package_name: library/perl-5/io-zlib
Version:	1.10
IPS_component_version: 1.10
Group:          Development/Libraries                    
Summary:	IO::Zlib - IO::Zlib
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~tomhughes/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/T/TO/TOMHUGHES/IO-Zlib-%{tarball_version}.tar.gz
...
Meta(info.upstream_url):        http://search.cpan.org/~tomhughes/%{tarball_name}-%{tarball_version}
