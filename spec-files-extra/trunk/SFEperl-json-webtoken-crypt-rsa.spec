#
# spec file for package: SFEperl-json-webtoken-crypt-rsa
#
...
%define tarball_version 0
%define tarball_name    JSON-WebToken-Crypt-RSA

Name:		SFEperl-json-webtoken-crypt-rsa
IPS_package_name: library/perl-5/json-webtoken-crypt-rsa
Version:	0
IPS_component_version: 0
Group:          Development/Libraries                    
Summary:	JSON::WebToken::Crypt::RSA - JSON::WebToken::Crypt::RSA
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~xaicron/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/X/XA/XAICRON/JSON-WebToken-%{tarball_version}.05.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Yuji Shimada <xaicron@cpan.org>
Meta(info.upstream_url):        http://search.cpan.org/~xaicron/%{tarball_name}-%{tarball_version}
