#
# spec file for package: SFEperl-json-webtoken
#
...
%define tarball_name    JSON-WebToken

Name:		SFEperl-json-webtoken
IPS_package_name: library/perl-5/json-webtoken
Version:	0.10
IPS_component_version: 0.10
Group:          Development/Libraries                    
Summary:	JSON::WebToken - JSON::WebToken
License:	Artistic
...
Source0:	http://search.cpan.org/CPAN/authors/id/X/XA/XAICRON/JSON-WebToken-%{tarball_version}.tar.gz
