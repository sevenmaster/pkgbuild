#
# spec file for package: SFEperl-locale-maketext
#
...
%define tarball_version 1.26
%define tarball_name    Locale-Maketext

Name:		SFEperl-locale-maketext
IPS_package_name: library/perl-5/locale-maketext
Version:	1.26
IPS_component_version: 1.26
Group:          Development/Libraries                    
Summary:	Locale::Maketext - Framework for software localization
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~ferreira/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/T/TO/TODDR/Locale-Maketext-%{tarball_version}.tar.gz
