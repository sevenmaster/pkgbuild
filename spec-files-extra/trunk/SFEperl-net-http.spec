#
# spec file for package: SFEperl-net-http
#
...
%define tarball_name    Net-HTTP

Name:		SFEperl-net-http
IPS_package_name: library/perl-5/net-http
Version:	6.06
...
Source0:	http://search.cpan.org/CPAN/authors/id/G/GA/GAAS/Net-HTTP-%{tarball_version}.tar.gz
