#
# spec file for package: SFEperl-parse-recdescent
#
...
%define tarball_version 1.967013
%define tarball_name    Parse-RecDescent

Name:		SFEperl-parse-recdescent
IPS_package_name: library/perl-5/parse-recdescent
Version:	1.967013
IPS_component_version: 1.967013
Group:          Development/Libraries                    
Summary:	Parse::RecDescent - Recursive descent parser generator
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~dconway/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/J/JT/JTBRAUN/Parse-RecDescent-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Damian Conway <damian@conway.org>
Meta(info.upstream_url):        http://search.cpan.org/~dconway/%{tarball_name}-%{tarball_version}
