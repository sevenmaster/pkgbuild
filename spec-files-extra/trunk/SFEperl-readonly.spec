#
# spec file for package: SFEperl-readonly
#
...
%define tarball_name    Readonly

Name:		SFEperl-readonly
IPS_package_name: library/perl-5/readonly
Version:	2.05
...
Url:		http://search.cpan.org/~sanko/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/S/SA/SANKO/Readonly-%{tarball_version}.tar.gz
...
Meta(info.upstream_url):        http://search.cpan.org/~sanko/%{tarball_name}-%{tarball_version}
