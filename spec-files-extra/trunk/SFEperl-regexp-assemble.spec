#
# spec file for package: SFEperl-regexp-assemble
#
...
%define tarball_name    Regexp-Assemble

Name:		SFEperl-regexp-assemble
IPS_package_name: library/perl-5/regexp-assemble
Version:	0.38
IPS_component_version: 0.38
Group:          Development/Libraries                    
Summary:	Regexp::Assemble - Regexp::Assemble
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~rsavage/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/R/RS/RSAVAGE/Regexp-Assemble-%{tarball_version}.tgz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Ron Savage <ron@savage.net.au>
Meta(info.upstream_url):        http://search.cpan.org/~rsavage/%{tarball_name}-%{tarball_version}
