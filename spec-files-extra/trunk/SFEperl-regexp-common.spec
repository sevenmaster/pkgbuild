#
# spec file for package: SFEperl-regexp-common
#
...
%define tarball_version 2017060201
%define tarball_name    Regexp-Common

Name:		SFEperl-regexp-common
IPS_package_name: library/perl-5/regexp-common
Version:	2017060201
IPS_component_version: 2017060201
Group:          Development/Libraries                    
Summary:	Regexp::Common - Regexp::Common
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~abigail/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/A/AB/ABIGAIL/Regexp-Common-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Abigail <cpan@abigail.be>
Meta(info.upstream_url):        http://search.cpan.org/~abigail/%{tarball_name}-%{tarball_version}
