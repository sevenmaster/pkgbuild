#
# spec file for package: SFEperl-sys-meminfo
#
...
%define tarball_name    Sys-MemInfo

Name:		SFEperl-sys-meminfo
IPS_package_name: library/perl-5/sys-meminfo
Version:	0.99
IPS_component_version: 0.99
Group:          Development/Libraries                    
Summary:	Sys::MemInfo - Sys::MemInfo
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~scresto/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/S/SC/SCRESTO/Sys-MemInfo-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            sylvain cresto <scresto [_at_] gmail.com>
Meta(info.upstream_url):        http://search.cpan.org/~scresto/%{tarball_name}-%{tarball_version}
