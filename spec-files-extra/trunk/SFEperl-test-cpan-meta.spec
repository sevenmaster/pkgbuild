#
# spec file for package: SFEperl-test-cpan-meta
#
...
%define tarball_name    Test-CPAN-Meta

Name:		SFEperl-test-cpan-meta
IPS_package_name: library/perl-5/test-cpan-meta
Version:	0.25
IPS_component_version: 0.25
Group:          Development/Libraries                    
Summary:	Test::CPAN::Meta - Test::CPAN::Meta
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~barbie/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/B/BA/BARBIE/Test-CPAN-Meta-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Barbie <barbie@missbarbell.co.uk>
Meta(info.upstream_url):        http://search.cpan.org/~barbie/%{tarball_name}-%{tarball_version}
