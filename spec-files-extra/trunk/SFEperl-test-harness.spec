#
# spec file for package: SFEperl-test-harness
#
...
%define tarball_name    Test-Harness

Name:		SFEperl-test-harness
IPS_package_name: library/perl-5/test-harness
Version:	3.36
IPS_component_version: 3.36
Group:          Development/Libraries                    
Summary:	Test::Harness - Executes perl-style tests and analyzes TAP
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~andya/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/L/LE/LEONT/Test-Harness-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Andy Armstrong <andy@hexten.net>
Meta(info.upstream_url):        http://search.cpan.org/~andya/%{tarball_name}-%{tarball_version}
