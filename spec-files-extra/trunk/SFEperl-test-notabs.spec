#
# spec file for package: SFEperl-test-notabs
#
...
%define tarball_name    Test-NoTabs

Name:		SFEperl-test-notabs
IPS_package_name: library/perl-5/test-notabs
Version:	1.4
IPS_component_version: 1.4
Group:          Development/Libraries                    
Summary:	Test::NoTabs - Test::NoTabs
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~bobtfish/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/B/BO/BOBTFISH/Test-NoTabs-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Tomas Doran <bobtfish@bobtfish.net>
Meta(info.upstream_url):        http://search.cpan.org/~bobtfish/%{tarball_name}-%{tarball_version}
