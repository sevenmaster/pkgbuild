#
# spec file for package: SFEperl-xml-dumper
#
...
%define tarball_name    XML-Dumper

Name:		SFEperl-xml-dumper
IPS_package_name: library/perl-5/xml-dumper
Version:	0.81
IPS_component_version: 0.81
Group:          Development/Libraries                    
Summary:	XML::Dumper - Converts XML from/to Perl code
License:	Artistic
#Distribution:   OpenSolaris
#Vendor:         OpenSolaris Community
Url:		http://search.cpan.org/~mikewong/%{tarball_name}-%{tarball_version}
SUNW_Basedir:	%{_basedir}
SUNW_Copyright: %{license}.copyright
Source0:	http://search.cpan.org/CPAN/authors/id/M/MI/MIKEWONG/XML-Dumper-%{tarball_version}.tar.gz

BuildRequires:	%{pnm_buildrequires_perl_default}
Requires:	%{pnm_requires_perl_default}

Meta(info.maintainer):          roboporter by pkglabo.justplayer.com <pkgadmin@justplayer.com>
Meta(info.upstream):            Mike Wong <mike_w3@pacbell.net>
Meta(info.upstream_url):        http://search.cpan.org/~mikewong/%{tarball_name}-%{tarball_version}
