#
# spec file for package SFEpython27-cryptography
#
# includes module(s): cryptography
#
%include Solaris.inc
...
%define src_name        cryptography
%define githubowner1    pyca
%define githubproject1  %{src_name}


Name:                    SFEpython27-cryptography
IPS_Package_Name:	 library/python/cryptography-27
Summary:                 provides cryptographic recipes and primitives
URL:                     https://github.com/eliben/cryptography
Version:                 2.1.4
...
%package -n SFEpython-cryptography
IPS_Package_Name:	 library/python/cryptography
Summary:                 %{summary}
...
%prep
#%setup -q -n cryptography-release_v%version
...
- Initial spec file version 2.1.4
