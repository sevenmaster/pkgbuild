#
# spec file for package SFEpython27-paramiko
#
...
%define githubowner1    paramiko
%define githubproject1  %{src_name}


Name:                    SFEpython27-paramiko
IPS_Package_Name:	 library/python/paramiko-27
Summary:                 SSH2 protocol library
URL:                     https://github.com/eliben/paramiko
Version:                 2.4.0
...
%package -n SFEpython-paramiko
IPS_Package_Name:	 library/python/paramiko
Summary:                 %{summary}
...
%prep
#%setup -q -n paramiko-release_v%version
...
- Initial spec file version 2.4.0 for python27
