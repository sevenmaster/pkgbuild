...
URL:			http://www.r-project.org/web/packages/car/index.html
License:		GPLv2+
SUNW_Copyright: 	%{name}.copyright
Group:			Applications/Math
Source:			ftp://cran.r-project.org/pub/R/contrib/main/%{packname}_%{version}-%{packrel}.tar.gz
...
- change Name SFER* -> SFEr* and (Build)Requires SFER -> SFEr
- add/change BuildRequires (lowercase)
