...
patch32:		samba410-32-remove-libiconv.diff
patch33:		samba410-33-provision-add-smb.conf-extra-defaults.diff
...
Remember to add a [homes] section and a [sysvol] section.
A quick configuraiton guide should be available on the SFE website.
...
#find sendfilev64 for test_unique_object_sids
export EXTRA_LDFLAGS="-lncurses -lsendfile"
...
%files
%defattr(-, root, bin)
%doc COPYING README.Coding WHATSNEW.txt
