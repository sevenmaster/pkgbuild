...
# ONLY USEFUL FOR OMNIOS

%include Solaris.inc
%include packagenamemacros.inc

Name:                SFEslang
IPS_Package_Name:	library/slang
Summary:             multi-platform programmer's library
Version:             2.2.4
Source:              ftp://ftp.fu-berlin.de/pub/unix/misc/slang/v2.2/slang-%{version}.tar.gz

SUNW_BaseDir:        %{_basedir}
BuildRoot:           %{_tmppath}/%{name}-%{version}-build
%include default-depend.inc

#BuildRequires: %{pnm_buildrequires_SUNWpng_devel}
#Requires:      %{pnm_requires_SUNWpng}
#pnm macro doesn't manage to resolve propperly, so for now use explicit ips name from SFElibpng.spec 
BuildRequires: image/library/libpng16
Requires:      image/library/libpng16
...
#saw cd objs even mkdir -p -- objs was printed before
...
- Bump to 2.2.4 - unarchived for OmniOS
