...
Patch3:       cairo-03-pthread-solaris.diff
...
%description
Note: This package is delivering a cairo version new enough for
PDF lib poppler. It is only needed for osdistro where cairo is
not at version 0.10 or newer.
