...
# fix OS displayed in "About LibreOffice" dialogue. Currently displays "OS Version: unknown;"	Update: done, TBC
...
# If LO4 mediation, perhaps remove package rename. Not entirely sure what this is for....libreoffice to libreoffice4 maybe or intor of libreoffice4-desktop-int?
#
...
#
BuildRequires:	SFEliborcus-010-gpp
Requires:	SFEliborcus-010-gpp
...
#
# Disable tests in dbaccess module
#gsed -i.orig	\
#	-e '/CppunitTest_dbaccess_macros_test/d' \
...
#	sw/Module_sw.mk	\
#	;
## Disable tests in postprocess module
#gsed -i.orig	\
#	-e '/CppunitTest_services/d'		\
#	postprocess/Module_postprocess.mk	\
#	;

## Disable tests in writerperfect module
#gsed -i.orig	\
#	-e '/CppunitTest_writerperfect_draw/d'	\
