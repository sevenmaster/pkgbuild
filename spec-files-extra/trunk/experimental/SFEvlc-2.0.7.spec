...
#http://www.velocityreviews.com/forums/t737908-gcc-std-c99-fail-to-compile-clock_gettime.html
#export CXXFLAGS="${CXXFLAGS} -D_XOPEN_SOURCE=500"
#export CFLAGS="${CFLAGS} -D_XOPEN_SOURCE=500"

#give these flags only to the C-Pre-Processor
#export CPPFLAGS="-I/usr/X11/include -I/usr/gnu/include -I/usr/include/libavcodec -I/usr/include/libavutil -I./include -D__EXTENSIONS__"
...
gmake am__v_CC_0= --debug=j AM_DEFAULT_VERBOSITY=1 -j$CPUS || echo "gmake 1. run failed, start over without vlc-cache-gen..."
gmake am__v_CC_0= --debug=j AM_DEFAULT_VERBOSITY=1 -j1
##NOTE## If you run into compile problems and "vlc-cache-gen" core dumps,
#        then you *first* uninstall the old copy of vlc and re-try. 
